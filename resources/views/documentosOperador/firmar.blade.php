                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <ul class="nk-block-tools g-3">
                                        <li class="nk-block-tools-opt">
                                            <a href="{{ url('/mis-documentos') }}" class="btn btn-secondary">
                ...
                <div class="nk-block nk-block-lg">
                    <div class="card card-bordered">
                        <div class="card-inner">
                            <form id="formFirma" action="{{ url('/mis-documentos/' . $data->id . '/completar-firma') }}"
                                ...
                                <div class="row g-gs">
                                    ...
                                    <div class="col-md-12">
                                        <label class="form-label" for="customFileLabel">Visualice el documento antes de
                                            firmar</label>
                                        <iframe src="{{ asset($data->archivo_firmado) }}" style="width:100%; height:400px;"
