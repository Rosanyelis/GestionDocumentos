  ...
  NioApp.SummerNote = function () {
    ...
    if ($(_basic).exists()) {
      $(_basic).each(function () {
        $(this).summernote({
          placeholder: 'Por favor inserte el texto de su firma.',
          tabsize: 2,
          height: 120,
          toolbar: [['style', ['style', 'bold', 'italic', 'underline', 'clear']], ['fontNames', ['Arial', 'Dancing Script']], ['fontsize', ['fontsize', 'height']],['view', ['codeview', 'help']]]
        });
      });
    }
